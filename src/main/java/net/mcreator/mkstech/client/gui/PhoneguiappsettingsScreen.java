...
import net.mcreator.mkstech.network.PhoneguiappsettingsButtonMessage;
...
public class PhoneguiappsettingsScreen extends AbstractContainerScreen<PhoneguiappsettingsMenu> {
	private final static HashMap<String, Object> guistate = PhoneguiappsettingsMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	ImageButton imagebutton_home_button;

	public PhoneguiappsettingsScreen(PhoneguiappsettingsMenu container, Inventory inventory, Component text) {
