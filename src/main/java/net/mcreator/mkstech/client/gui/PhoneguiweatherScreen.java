...
public class PhoneguiweatherScreen extends AbstractContainerScreen<PhoneguiweatherMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.mks_tech.phoneguiweather.label_set_weather"), 23, 24, -1);
	}
	...
	public void init() {
		...
		button_clear = new Button(this.leftPos + 23, this.topPos + 40, 51, 20, new TranslatableComponent("gui.mks_tech.phoneguiweather.button_clear"), e -> {
			if (true) {
		...
		button_clear1 = new Button(this.leftPos + 23, this.topPos + 64, 51, 20, new TranslatableComponent("gui.mks_tech.phoneguiweather.button_clear1"), e -> {
			if (true) {
