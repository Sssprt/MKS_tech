...
@Mod("mks_tech")
public class MksTechMod {
	public static final Logger LOGGER = LogManager.getLogger(MksTechMod.class);
	public static final String MODID = "mks_tech";
