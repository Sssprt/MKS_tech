...
public class SmartwatchNewYellowItem extends Item {
	public SmartwatchNewYellowItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Model: New"));
		list.add(new TextComponent("Color: Yellow"));
	}
}
